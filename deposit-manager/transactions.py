...
from configs import PROJ_DIR, COLLECTION_ADDR
...
def refund_utxo(refund_address, utxo_id):
    ...
    protocol_param_fp = get_protocol_params(PROJ_DIR)

    raw_matx_path = build_raw_transaction(PROJ_DIR,
                                          utxo,
    ...
    signed_matx_path = sign_tx(PROJ_DIR,
                               payment_wallet,
                               raw_matx_path)
